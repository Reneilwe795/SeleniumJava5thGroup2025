...
public class LoginToLearningMaterials {
    ...
    public void startBrowser() throws InterruptedException {
        //driver = new ChromeDriver();
        driver.get("http://www.ndosiautomation.co.za/");
    ...
    public void enterEmail() {
        driver.findElement(By.id("login-email")).sendKeys("rcstest@gmail.com");
    }
    @Test(priority = 4)
    public void enterPassword() {
        driver.findElement(By.id("login-password")).sendKeys("95354601");
    }
    @Test(priority = 5)
